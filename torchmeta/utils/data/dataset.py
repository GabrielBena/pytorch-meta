...
class CombinationMetaDataset(MetaDataset):
    ...
    def __init__(self, dataset, num_classes_per_task, target_transform=None, dataset_transform=None):
    ...
    def __getitem__(self, index):
        ...
        task = ConcatTask(
            ...
            target_transform=wrap_transform(
                self.target_transform, self._copy_categorical, transform_type=Categorical
            ),
        )
